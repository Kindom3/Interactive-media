...
Assignment.
Get LED on using bread board and micro controller. Then utilize left and right installed switches to turn on and off. Assignment was a success, image to be uploaded
